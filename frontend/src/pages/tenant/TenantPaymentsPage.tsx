      ...
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-semibold mb-2" style={{fontFamily: 'santhoshi, sans-serif'}}>Rent Payments</h1>
              <p className="text-green-100">Manage your rent payments conveniently</p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-semibold text-green-100" style={{fontFamily: 'santhoshi, sans-serif'}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-semibold text-green-600" style={{fontFamily: 'santhoshi, sans-serif'}}>
                  {payments.filter(p => p.status === 'PAID').length}
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-semibold text-blue-600" style={{fontFamily: 'santhoshi, sans-serif'}}>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-2xl font-semibold text-yellow-600" style={{fontFamily: 'santhoshi, sans-serif'}}>
        ...
        {pendingPayment && room && (
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-gray-900" style={{fontFamily: 'santhoshi, sans-serif'}}>Pay Rent – {formatMonth(pendingPayment.month)}</h2>
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t pt-3 flex justify-between items-center">
                  ...
                  <span className="text-2xl font-semibold text-green-600" style={{fontFamily: 'santhoshi, sans-serif'}}>₹{pendingPayment.amount}</span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="block text-xl font-semibold tracking-tight mb-0.5" style={{fontFamily: 'santhoshi, sans-serif'}}>Pay via Mobile Apps</span>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="block text-xl font-semibold text-slate-900 tracking-tight mb-0.5" style={{fontFamily: 'santhoshi, sans-serif'}}>Pay in Cash</span>
              ...
              {payments.map((payment) => (
                <div key={payment.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200 hover:border-green-300">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-semibold text-gray-900 mb-2" style={{fontFamily: 'santhoshi, sans-serif'}}>₹{payment.amount}</div>
